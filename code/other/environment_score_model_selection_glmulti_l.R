...
model_selection_macronutrients_l <- glmulti(full_model_macronutrients, level = 1, crit="aicc", method="l", confsetsize=20000)#same model is chosen having 100,1000,10000 possible models
